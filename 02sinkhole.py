...
def plot_component_bar_charts(df1, label1, df2, label2):
    ...
    plt.suptitle(f"Baseline vs Sinkhole Attack - Component Energy Breakdown", fontsize=16)
...
if __name__ == "__main__":
    ...
    attack_file = "C:/Logs/attacks/Sinkhole.txt"
    ...
    plot_comparison(df_baseline, "Baseline", df_attack, "Sinkhole Attack", node_to_compare)
    plot_total_energy_bar(df_baseline, "Baseline", df_attack, "Sinkhole Attack", node_to_compare)
    plot_total_energy_comparison(df_baseline, "Baseline", df_attack, "Sinkhole Attack")
    plot_component_bar_charts(df_baseline, "Baseline", df_attack, "Sinkhole Attack")

    comparison_table = generate_energy_comparison_table(df_baseline, "Baseline", df_attack, "Sinkhole Attack")
    print("\n=== Energy Comparison Table (in mJ) ===\n")
    print(comparison_table)

    plot_percentage_increase_chart(comparison_table)
    comparison_table.to_csv("G:/_Project2025/energy_comparison_sinkhole.csv", index=False)
